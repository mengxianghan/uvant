...
import { createNamespace, isNumeric, makeNumericProp, makeStringProp, numericProp, truthProp } from '../utils'
import { isDef } from './../utils/basic'

export const { name, bem } = createNamespace('tabs')
